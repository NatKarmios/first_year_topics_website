...
const semanticsMeaning = () => (
  <Page>
    <h1>Semantics - a fancy word for "meaning" (obviously with its nuances).</h1>
...
const compactSemanticRepresentationMeaning = () => (
  <Page>
    <h1>Compact semantic representation - trying to convey the most meaning in a very small space.</h1>
...
const vaeMeaning = () => (
  <Page>
    ...
    These are a type of artificial neural network that's very good at finding
...
const vaeExample = () => (
  <Page>
    <h1>Let's concretify this with an example.</h1>
...
const vaeMeaningCont = () => (
  <Page>
    <h1>A VAE can be thought as two neural networks that work together in a clever way.</h1>
...
const vaeExampleCont = () => (
  <Page>
    <h1>Again, let's make this concrete with an example.</h1>
